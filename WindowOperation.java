...
public class WindowOperation extends JFrame implements ItemListener, ActionListener {
	Jiangjin jiang;
	String job;
	JTextField Number;
	JLabel L1, L2, L3;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (Number.getText().trim().equals("") || Number.getText().length() == 0) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "您还没选择职位或输入的时间格式错误(单位:h)", "提示", JOptionPane.WARNING_MESSAGE);
			}
		}
	}
}
